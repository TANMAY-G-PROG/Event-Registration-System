...
export default function AuthCallback() {
  ...
  // PIN fields — digits only, max 6 chars
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    const { usn, sem, mobno, organizerPin, confirmPin } = formData;
    ...
    try {
      const res = await fetch(`${import.meta.env.VITE_API_URL || ''}/api/complete-google-signup`, {
        ...
        body: JSON.stringify({ usn, sem: semNum, mobno, organizerPin })
      });
        ...
        <div style={{ textAlign: 'center' }}>
          <div style={{ fontSize: '2.5rem', fontWeight: 700, marginBottom: 24 }}>
            FLO<span style={{
              ...
              background: 'var(--nb-yellow, #FFE500)',
              border: '3px solid var(--nb-black, #0a0a0a)',
  ...
  return (
    <div className="forgot-password-page">
      ...
      {/* Toast — fixed at viewport top, always visible regardless of scroll */}
      {message.show && (
      ...
      <div className="forgot-card" style={{ maxWidth: 500 }}>
        ...
        {/* Google name display — read only */}
        {googleName && (
          <div style={{
            background: 'var(--sand-deep, #f0ece0)',
            border: '1.5px solid var(--sand-border, #ddd)',
            padding: '10px 14px',
            marginBottom: 20,
            ...
            <span style={{
              opacity: 0.6, fontSize: 10, textTransform: 'uppercase',
              letterSpacing: '0.06em', fontFamily: 'DM Mono, monospace', display: 'block', marginBottom: 2
            }}>
              Signed in as
            </span>
        ...
        <form className="forgot-form" onSubmit={handleSubmit}>
          ...
          <div>
            ...
            }}>University Serial No. (USN)</label>
            <input
              type="text"
              name="usn"
          ...
          <div style={{ display: 'flex', gap: 12 }}>
            <div style={{ flex: 1 }}>
              ...
              <input
                type="number" name="sem" placeholder="1–8" min="1" max="8"
            ...
            <div style={{ flex: 2 }}>
              ...
              <input
                type="tel" name="mobno" placeholder="9876543210"
          ...
          <p style={{ margin: '0 0 4px', fontSize: 12.5, opacity: 0.65 }}>
            This PIN protects sub-event management on your device. Keep it separate from your login password.
          </p>
          ...
          <div>
            <label style={{
              ...
              fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.1em',
              marginBottom: 6, opacity: 0.7
            }}>PIN (4–6 digits)</label>
            <div style={{ position: 'relative' }}>
              <input
                type={showPin ? 'text' : 'password'}
                name="organizerPin"
                placeholder="e.g. 1234"
                value={formData.organizerPin}
