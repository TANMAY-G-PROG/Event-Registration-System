...
export default function Login() {
  ...
  // ── After login, check if admin and route accordingly ─────────
  ...
  const handleSignUpChange = (e) => {
    ...
    setSignUpData(prev => ({ ...prev, [name]: name === "usn" ? value.toUpperCase() : value }));
  };
    ...
    <div className="login-page">
      ...
      <div className="top-nav-buttons">
        <button className="button" onClick={goTo("/about-us")}>
          {[1,2,3,4,5,6,7].map(i => <div key={i} className={`bubble-layer bubble-${i}`} />)}
          <span>About Us</span>
        </button>
      ...
      <div className={`container desktop-view ${isActive ? "active" : ""}`} id="container">
          ...
          <form onKeyPress={handleKeyPress}>
            ...
            <div className="password-wrapper">
              <input type={showPassword.signUp ? "text" : "password"} name="password"
                placeholder="Password" value={signUpData.password} onChange={handleSignUpChange} />
        ...
        <div className="form-container sign-in">
          <form onKeyPress={handleKeyPress}>
            ...
            <div className="password-wrapper">
              <input type={showPassword.signIn ? "text" : "password"} name="password"
                placeholder="Password" value={signInData.password} onChange={handleSignInChange} />
            ...
            <a href="#" onClick={(e) => { e.preventDefault(); navigate("/forgot-password"); }}
              className="forgot-password-link">Forgot Your Password?</a>
              ...
              {!isActive ? (
                <div className="m-form-group">
                  ...
                  <div className="m-forgot-wrapper">
                    <a href="#" onClick={(e) => { e.preventDefault(); navigate("/forgot-password"); }}
                      className="m-forgot-link">Forgot Your Password?</a>
                  </div>
                </div>
              ) : (
                <div className="m-form-group">
    ...
    <div className={`m-input-wrapper ${half ? "m-half" : ""}`}>
      ...
      <div className="m-input-container">
        <input type={inputType} name={name} value={value} onChange={onChange}
          placeholder={placeholder} className="m-input-field" />
        {isPassword && (
